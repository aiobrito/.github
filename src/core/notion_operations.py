...
class NotionOperations:
    """Operações otimizadas para Notion API"""
    def __init__(self):
    ...
    def create_entry(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(f"Erro na criação: {str(e)}") from e
            ...
            return {
                ...
                "properties": {
                    "Keywords": {
                        "multi_select": [
                            {"name": kw} for
                            kw in enhanced_keywords]
                    }
                }
            }
        except Exception as e:
            raise RuntimeError(f"Erro no enriquecimento: {str(e)}") from e

    def create_blocks(
        self, page_id: str, content_type: str = "technical"
    ) -> Dict[str, Any]:
        """
                ...
                },
                {
                    ...
                    "paragraph": {
                        "rich_text": [{
                            ...
                            "text": {
                                "content": (
                                    "Estrutura base para documentação técnica "
        ...
        try:
            ...
            raise RuntimeError(f"Erro na criação de blocos: {str(e)}") from e